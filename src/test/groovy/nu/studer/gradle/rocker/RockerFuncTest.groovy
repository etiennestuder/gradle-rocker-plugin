...
"""
    ...
    void "generates exactly the same output for the same input when optimize=true, regardless of the last-modified time of the template"() {
        given:
        template('src/rocker/main/Example.rocker.html')
...
"""
        ...
        where:
        updateLastModifiedTimestamp << [true, false]
    }
