...
"""
        ...
        result.task(':compileMainRocker').outcome == TaskOutcome.SUCCESS
...
"""
        ...
        when:
        def result = runWithArguments('compileMainRocker')
        ...
        when:
        result = runWithArguments('compileMainRocker')

        then:
        result.task(':compileMainRocker').outcome == TaskOutcome.UP_TO_DATE
    }
...
"""
        ...
        when:
        runWithArguments('compileMainRocker')
        ...
        then:
        !fileExists('src/generated/rocker/Example.java')
        result.task(':cleanCompileMainRocker').outcome == TaskOutcome.SUCCESS
    }
