...
"""
    ...
    void "generates exactly the same output for the same input regardless of optimize flag (was #optimize)"() {
        given:
        template('src/rocker/main/Example.rocker.html')
...
"""
        ...
        contentSecondRun == contentFirstRun
...
"""
    ...
    void "task output is cacheable even if optimize=off"() {
        given:
        exampleTemplate()
