...
public class RockerPlugin implements Plugin<Project> {
    ...
    public void apply(final Project project) {
        ...
        final String rockerLogLevel = calculateLogLevel(project);
        ...
        container.all(new Action<RockerConfig>() {
            ...
            public void execute(RockerConfig config) {
                ...
                rocker.setLogLevel(project.getGradle().getStartParameter().getLogLevel());
    ...
    private String calculateLogLevel(Project project) {
        StartParameter startParameter = project.getGradle().getStartParameter();
        return startParameter.getLogLevel().toString();
    }
